...
const buttonStyles = {
	variant: {
		...
		outline:
			'border  text-secondary-foreground  bg-background hover:bg-accent hover:text-accent-foreground',
...
export function buttonVariants(
    ...
    rounded-md text-sm font-bold ring-offset-background   
