...
export const DialogSwitchAi: React.FC<DialogSwitchAiProps> = ({ triger }) => {
	...
	return (
		<Dialog>
			...
			<DialogContent className='sm:max-w-[425px]'>
				<DialogHeader>
					<DialogTitle>AI Yordamchini Tanlang</DialogTitle>
					{/* <DialogDescription>
						So'zlarni tarjima qilish va misollar yaratish uchun AI yordamchini tanlang. Har bir AI
						ning o'z afzalliklari bor.
					</DialogDescription> */}
				</DialogHeader>
            ...
            `}
				...
				<DialogFooter>
					<DialogClose asChild>
						<Button variant='outline'>Tayyor</Button>
					</DialogClose>
				</DialogFooter>
			</DialogContent>
		</Dialog>
